...
# Instructions
# -------------
#   1. Click on any two boxes to mark start and finish point.
#   2. Make some obstacles on the other boxes.
#   3. Press SPACE to find the shortest path between the start and end point.
#   4. The path in Purple(Violet) Color is the shortest path and the Red portion is the path explored by the algorithm.
